						...
						<div class="form-group">
							...
							<div class="col-md-6">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <label>
                                        <input type="checkbox" name="permissions[]" id="{{ $permission->name }}" value="{{ $permission->id }}" {!! (!empty($inroles) && in_array($permission->id, $inroles) ? 'checked' : '') !!}> {{ $permission->permission }}
                                        </label>
                                    </div>
                                    @endforeach
                                    @endif
